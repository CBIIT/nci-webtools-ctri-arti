...
const TOOLS = [
  ...
  - After using this tool, use the getWebsiteText tool to get the full content of each web page for further analysis.
...
- NOTE: Please use https://www.opm.gov/policy-data-oversight/latest-memos/ to retrieve the latest memos from the Office of Personnel Management.
        ...
        <div class="input-group w-auto align-items-center">
          ...
          <div class="form-check form-switch mb-0 form-control-sm d-flex align-item-center">
            ...
            <label class="form-check-label text-secondary cursor-pointer" for="researchMode">
              <span class="visually-hidden">Enable Reasoning</span>
