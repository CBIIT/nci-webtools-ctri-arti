  ...
  return html`
    ...
    <div class="container pb-4">
      ...
      <div class="row position-relative mb-5" style="margin-top:-80px">
        <h1 class="offset-sm-2 offset-md-3 offset-xl-4 col-auto font-title text-white fw-bold display-5">User Profile</h1>
      </div>
      <div class="row mt-4 mb-5">
        <h1 class="offset-sm-2 offset-md-3 offset-xl-4 col-auto fs-3">${() => session()?.user?.email || ''}</h1>
      ...
      <${Show} when=${() => !session.loading}>
        <form onSubmit=${handleSubmit} class="mb-5">
          ...
          <div class="row align-items-center mb-2">
            <!-- Email -->
            <label class="offset-sm-2 offset-md-3 offset-xl-4 col-sm-3 col-xl-2 align-self-center col-form-label form-label-user fw-semibold">Email</label>
            <div class="col-sm-3 col-xl-2">
          ...
          <div class="row align-items-center mb-2">
            <!-- Status -->
            <label class="offset-sm-2 offset-md-3 offset-xl-4 col-sm-3 col-xl-2 align-self-center col-form-label form-label-user fw-semibold">Status</label>
            <div class="col-sm-3 col-xl-2">
          ...
          <div class="row align-items-center mb-2">
            <!-- Role -->
            <label class="offset-sm-2 offset-md-3 offset-xl-4 col-sm-3 col-xl-2 align-self-center col-form-label form-label-user fw-semibold">Role</label>
            <div class="col-sm-3 col-xl-2">
