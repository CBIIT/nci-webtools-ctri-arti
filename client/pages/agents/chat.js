    ...
    <main class="container d-flex flex-column flex-grow-1 mb-3 position-relative">
      <div class="flex-grow-1 py-3">
        <div class="text-center my-5 font-serif" hidden=${() => messages().length > 0}>
          <h1 class="display-6">Welcome to Research Optimizer</h1>
      ...
      <small class="text-center text-muted py-1">To maintain privacy, we never retain your data on our systems. Please double-check statements, as Research Optimizer can make mistakes.
      </small>
    </main>
  `;
}
