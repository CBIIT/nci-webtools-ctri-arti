...
export function DataTable(props) {
  ...
  return html`
    ...
    <div class="d-flex align-items-center justify-content-end mt-3" style="gap: 40px; padding: 0;">
      <div class="page-count-label">
        Page ${() => (totalPages() === 0 ? 0 : currentPage())} of ${() => totalPages()}
      </div>
      <div class="d-flex align-items-center gap-2">
        <label for="rows-per-page" class="page-count-label">Rows per page:</label>
        <select
          id="rows-per-page"
